        ...
        let runtimeReportDictionary (report: SounioRuntimeProbeReport) =
            dict
                [ "detected", box report.Detected
                  ...
                  "snio_server_probe_attempted", box report.SnioServerProbeAttempted
                  "snio_server_probe_succeeded", box report.SnioServerProbeSucceeded
                  "snio_built_in_serve_supported", box (defaultArg report.SnioBuiltInServeSupported false)
                  "snio_serve_entry_path", box (defaultArg report.SnioServeEntryPath "")
                  "snio_info_values", box (ResizeArray(report.SnioInfoValues))
                  "snio_capabilities", box (defaultArg report.SnioCapabilities 0L)
                  "snio_health_ok", box (defaultArg report.SnioHealthOk false)
                  "snio_stats_value", box (defaultArg report.SnioStatsValue 0L)
